...
Inductive eval_expr: expr -> val -> Prop :=
  ...
  | eval_Eunop:  forall op a ty v1 v,
      eval_expr a v1 ->
      sem_unary_operation vptr op v1 (typeof a) = Some v ->
      eval_expr (Eunop op a ty) v
  | eval_Ebinop: forall op a1 a2 ty v1 v2 v,
      eval_expr a1 v1 ->
      eval_expr a2 v2 ->
      sem_binary_operation op v1 (typeof a1) v2 (typeof a2) (CCMemory.Mem.valid_pointer m) = Some v ->
      eval_expr (Ebinop op a1 a2 ty) v
  | eval_Ecast:   forall a ty v1 v,
      eval_expr a v1 ->
      sem_cast vptr v1 (typeof a) ty = Some v ->
...
Inductive eval_exprlist: list expr -> typelist -> list val -> Prop :=
  ...
  | eval_Econs:   forall a bl ty tyl v1 v2 vl,
      eval_expr a v1 ->
      sem_cast vptr v1 (typeof a) ty = Some v2 ->
...
Inductive step: state -> trace -> state -> Prop :=
  ...
  | step_assign:   forall f a1 a2 k e le m loc ofs v2 v m',
      ...
      sem_cast (vptr m) v2 (typeof a2) (typeof a1) = Some v ->
  ...
  | step_ifthenelse:  forall f a s1 s2 k e le m v1 b,
      ...
      bool_val (vptr m) v1 (typeof a) = Some b ->
  ...
  | step_return_1: forall f a k e le m v v' m',
      eval_expr e le m a v -> 
      sem_cast (vptr m) v (typeof a) f.(fn_return) = Some v' ->
      Mem.free_list m (blocks_of_env e) = Some m' ->
