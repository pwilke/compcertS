...
Extract Inlined Constant ValueAnalysis.trace_calls => "ValueAnalysisaux.trace_calls".
Extract Constant ValueAnalysis.print => "fun (f: bool -> unit) (x: bool) (y: 'a) -> f x; y".
Extract Constant ValueAnalysis.set_print => "fun (f: unit -> 'a) (x: 'b) -> 
Clflags.option_display_transfer := true;
f () ; 
Clflags.option_display_transfer := false;
x".
...
(* Extract Constant Mem.nb_boxes_max => *)
(*   "Camlcoq.Nat.of_int (2 ** (32 - coq_MA) - 2)". *)
...
Extract Constant Compiler.print_Linear => "PrintLinear.print_if".
...
Extract Constant Normalise.normalise => "Values_symbolic_aux.normalise".

Extract Constant Memory.MA => "Camlcoq.Nat.of_int (! MaxAlignment.max_alig)".
