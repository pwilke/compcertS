...
let print_operation reg pp = function
  ...
  | Oaddfs, [r1;r2] -> fprintf pp "addfs(%a,%a)" reg r1 reg r2
  | Osubfs, [r1;r2] -> fprintf pp "subfs(%a,%a)" reg r1 reg r2
  | Omulfs, [r1;r2] -> fprintf pp "mulfs(%a,%a)" reg r1 reg r2
  | Odivfs, [r1;r2] -> fprintf pp "divfs(%a,%a)" reg r1 reg r2
