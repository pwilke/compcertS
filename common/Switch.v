...
Inductive switch_argument: mem -> bool -> expr_sym -> Z -> Prop :=
| switch_argument_32: forall m i e,
                        Mem.mem_norm m e = Vint i ->
      switch_argument m false e (Int.unsigned i)
  | switch_argument_64: forall m i e,
                          Mem.mem_norm m e = Vlong i ->
      switch_argument m true e (Int64.unsigned i).
