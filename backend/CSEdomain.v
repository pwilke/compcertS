...
Definition valuation := valnum -> expr_sym.

Inductive rhs_eval_to (valu: valuation) (ge: genv) (sp: expr_sym) (m: mem):
                                                     rhs -> expr_sym -> Prop :=
  | op_eval_to: forall op vl v,
      eval_operation ge sp op (map valu vl) = Some v ->
...
Inductive equation_holds (valu: valuation) (ge: genv) (sp: expr_sym) (m: mem):
                                                      equation -> Prop :=
...
Record numbering_holds (valu: valuation) (ge: genv) (sp: expr_sym)
