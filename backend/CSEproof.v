...
+ (* load is preserved, but addressing is possibly simplified *)
  ...
  intros [res' [ADDR SE]].
  exploit eval_addressing_se. apply regs_lessdef_regs; eauto. eauto. (* eexact ADDR. *)
  intros [a' [A B]].
...
- (* Icond *)
  ...
  intros [res' [RES SE]].
  exploit eval_condition_se. eauto. apply regs_lessdef_regs; eauto. eauto. (* eexact RES. *)
  intros [v2 [A B]].
  econstructor; split.
